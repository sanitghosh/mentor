...
<?= $this->section('content') ?>
            ...
            <div id="content">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="<?php echo base_url('');?>"><img class="img-responsive" src="<?php echo base_url('assets/admin/images/logo/logo.png');?>" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="<?php echo base_url('assets/admin/images/layout_img/user_img.jpg');?>" alt="#" /><span class="name_user"><?=session()->get('name');?></span></a>
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="profile.html">My Profile</a>
                                       <a class="dropdown-item" href="settings.html">Settings</a>
                                       <a class="dropdown-item" href="help.html">Help</a>
                                       <a class="dropdown-item" href="<?php echo base_url('admin/logout');?>"><span>Log Out</span> <i class="fa fa-sign-out"></i></a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
               ...
               <div class="midde_cont">
                     ...
                     <div class="row column1">
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                 <i class="fa-regular fa-clock blue1_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa-regular fa-comment red_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="<?php echo base_url('assets/admin/images/layout_img/user_img.jpg');?>" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="<?php echo base_url('assets/admin/assets/admin/images/layout_img/msg2.png" class="img-responsive');?>" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="<?php echo base_url('assets/admin/images/layout_img/msg3.png" class="img-responsive');?>" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Smith</span>
                                       ...
                                       <li>
                                          <span><img src="<?php echo base_url('assets/admin/images/layout_img/msg2.png" class="img-responsive');?>" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Smith</span>
                                          <span class="msg_user">Sed ut perspiciatis unde omnis.</span>
                                          <span class="time_ago">12 min ago</span>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        <p>Copyright © <?=date('Y');?> Designed by subha. All rights reserved.
                        </p>
                     </div>
                  </div>
               </div>
